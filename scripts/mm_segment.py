...
def get_parser():
    ...
    optional.add_argument("-s", '--overlap', required=False, default = 90, type=float,
                         help="Spatial overlap during sliding window inference, higher percentage may improve accuracy but will reduce inference speed. Default is 90%. We recommend decreasing to 50% for large images (e.g., high-resolution or whole-body images).")
